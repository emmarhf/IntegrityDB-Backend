...
document.getElementById("upload-file").addEventListener("click", () => {
    document.getElementById("modal-carga-base").classList.remove("hidden");
});

document.getElementById("cancelar-carga").addEventListener("click", () => {
    document.getElementById("modal-carga-base").classList.add("hidden");
});
